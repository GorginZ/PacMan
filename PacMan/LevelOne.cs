...
namespace PacMan
{
  public class LevelOne : ILevel
  {
    ...
    void ILevel.BuildLevel()
    {
      ...
      new Coordinates(2, 9), new Coordinates(3, 9), new Coordinates(4, 9), new Coordinates(5, 9), new Coordinates(6, 9), new Coordinates(7, 9), new Coordinates(8, 9), new Coordinates(9, 9), new Coordinates(10, 10), new Coordinates(10, 9), 

      new Coordinates(1, 0), new Coordinates(2, 0), new Coordinates(3, 0), new Coordinates(4, 0), new Coordinates(5, 0), new Coordinates(6, 0), new Coordinates(7, 0), new Coordinates(8, 0), new Coordinates(9, 0), 
